...
import { IoLogoGithub, IoOpenOutline, IoLogoNpm } from "react-icons/io5";
  ...
  return (
    <div className="relative mt-16">
      <div className="w-[90%] md:w-[70%] ml-5 md:m-auto">
        <img
          className={`${
            projectType === "Front End" ? "border-sky-500" : "border-red-500"
          } shadow-xl border-[5px] p-1`}
          src={project.image}
        ...
        <p
          className={`${
            projectType === "Front End"
              ? "after:text-sky-600"
              : "after:text-red-600"
          } text-pink-600 font-bold after:absolute after:left-[24px] w-fit after:top-[1px] after:content-['FEATURED'] after:-z-10 before:content-['📢_']`}
        >
          <span
            className={`${
              projectType === "Front End" ? "text-sky-500" : "text-red-500"
            }`}
          >
            FEATURED{" "}
          </span>
      ...
      <div className="absolute top-[90%] md:top-[80%] ml-10 md:right-[10%] z-10 text-white w-[85%] md:w-[60%]">
        ...
        <div
          className={`${
            projectType === "Front End" ? "text-sky-500" : "text-red-500"
          } px-4 mt-4 text-xs sm:text-lg flex gap-6 font-bold flex-wrap`}
        >
